 ...
 * single location.  Pure C stuff goes here, the system-specific stuff is
 * kept over in unix.h. */
...
#define US_NOWARNING	8	/* don't get the kickout warning messages
				 * -Flint */
...
#define US_ANSIDEFAULT  512	/* colours switched on/off by default at
				 * startup? */
...
#define E_2ENTEREND     2	/* user can end the text using <return> 2
				 * times */
...
#define MAXTRIES 2		/* re-try this number of times if connect()
				 * fails   */
...
#define MAXWHO 1600		/* max. wholist entries (1200 users + 400
				 * friends) */
